...
subtitle: "**Simulation:** Epoch linear preferential sampling _(24 epochs -- 2 months/epoch)_ \n\n **Inference:** BESP _(24 epochs ~ 2 months/epoch)_"
...
```{r getstats, results='asis', cache=TRUE}
    ...
    for (i in 1:nrow(trajectories)) {     
      ...
      logfiles   <- paste0("besp.fixedtree.fixedgroups.", infname, ".", trajname, ".T", replicates, ".log")
...
```{r examples, results='asis', eval=TRUE, fig.pos="!h"}
...
for (i in 1:nrow(trajectories)) {  
  ...
  cat(paste0("![**", trajectories$shortnames[i], "** _(best ranked simulation, replicate ",best,")_: ",caption,"](",   logpath, "figures-short-log/besp.fixedtree.fixedgroups.", infname, ".", trajname,".T", best, ".pdf){width=90%}\n\n"))
  cat(paste0("![**", trajectories$shortnames[i], "** _(median ranked simulation, replicate ",median,")_: ",caption,"](", logpath, "figures-short-log/besp.fixedtree.fixedgroups.", infname, ".", trajname,".T", median, ".pdf){width=90%}\n\n"))
  cat(paste0("![**", trajectories$shortnames[i], "** _(worst ranked simulation, replicate ",worst,")_: ",caption,"](",  logpath, "figures-short-log/besp.fixedtree.fixedgroups.", infname, ".", trajname,".T", worst, ".pdf){width=90%}\n\n"))
